    ...
    return(
        <>
            <section id='contents' className='container-md'>
                <div className="mainimg" data-aos="fade-up" data-aos-duration="2000">
                    <img className='mainimg-dt' src="./img/R5-mainimg.png" alt="메인이미지" />
                    <img className='mainimg-mo' src="./img/R5-mainbanner-mo.png" alt="모바일메인이미지" />
                </div>
                <div      >
                    {/* content-1 */}
